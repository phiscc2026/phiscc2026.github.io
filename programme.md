...
|       | Clara Cabanillas de la Casa | Ram pressure stripping as a catalyst of star formation quenching in the Hydra I cluster                                      |
|       | Kale Boyes                  | Investigating HI ram pressure stripping in the NGC&nbsp;4532/<wbr/>DDO&nbsp;137 system on the outskirts of the Virgo cluster |
| 10:20 | *Break (40min)*             |                                                                                                                              |
| 11:00 | Lwandile Gwebushe           | Neutral hydrogen, HI, in the Shapley Supercluster core: Environmental effects on gas content and galaxy evolution            |
|       | Nushkia Chamba              | The edges of dwarf galaxies in stars and gas                                                                                 |
|       | Shinna Kim                  | The environmental dependence of the baryonic Tully&ndash;Fisher relation from WALLABY                                        |
...
#### Discussion
[Thursday afternoon](#breakout-sessions-ii), *led by:* Se-Heon Oh

| ----------- | -------------------------------------------------------------------------------------------------------------------- |
| Se-Heon Oh  | Quantifying gas disequilibrium in galaxy disks from MHONGOOSE                                                        |
| Hangyuan Li | Extending tilted-ring ritting with GPU-accelerated Bayesian inference                                                |
| Yukun Liu   | Machine learning for galaxy kinematics: Accurate kinematic and dynamical mass estimation from single-dish HI spectra |

#### Tutorial
[Thursday afternoon](#breakout-sessions-ii), *led by:* Nathan Deg

| ---------- | ----------------------------------------------------------------------------------- |
| Nathan Deg | Kinematics, structural parameters, and scaling relations: WALLABY, 3KIDNAS, and more |
